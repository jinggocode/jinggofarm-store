...
if ($_SERVER["REQUEST_URI"] == "/jinggofarm-store/auth/sign_in") {
	$config['identity']                   = 'email';
} else {
	$config['identity']                   = 'username';
}
// You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
