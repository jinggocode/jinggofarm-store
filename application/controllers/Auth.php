...
class Auth extends MY_Controller {
		...
		if ($this->form_validation->run() == true)
		{
			...
			else
			{
				...
				// redirect them back to the login page
		 		$this->message('Login gagal! periksa Email dan Password', 'warning');

				redirect($action.'/sign_in', 'refresh'); // use redirects instead of loading views for compatibility with MY_Controller libraries
			}
		}
		else
		{
	...
	public function create_user()
	{
		...
		else
		{
			...
			$this->render('auth/sign_up', $this->data);
		}
	}
