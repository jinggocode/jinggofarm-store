...
class Product extends MY_Controller
{
	...
	public function save()
	{
		...
		$this->form_validation->set_rules('harga_produksi', 'Harga Produksi', 'trim|required|min_length[1]|max_length[15]');
		$this->form_validation->set_rules('stok', 'Stok', 'trim|required|min_length[1]|max_length[3]');
		$this->form_validation->set_rules('opsi_kirim', 'Opsi Kirim', 'trim|required');
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$data['harga_produksi'] = str_replace(".", "", $this->input->post('harga_produksi'));
	...
	public function update()
	{
		...
		$this->form_validation->set_rules('harga_produksi', 'Harga Produksi', 'trim|required|min_length[1]|max_length[15]');
		$this->form_validation->set_rules('stok', 'Stok', 'trim|required|min_length[1]|max_length[3]');
		$this->form_validation->set_rules('sisa_stok', 'Sisa Stok', 'trim|required|min_length[1]|max_length[3]'); 
		$this->form_validation->set_rules('opsi_kirim', 'Opsi Kirim', 'trim|required');
