 ...
 *
 */
class Productbydate extends MY_Controller
{
	...
	public function index()
	{
		if ($this->input->get('action') == "submit") { 
			...
			$data = $this->report_model
				->getDataReportByDate($newDateFormat);
			$total = $this->report_model
				->getTotalDataReportByDate($newDateFormat);
			...
			$this->generateCsrf();
			$this->render('admin/report/productbydate/index', $data);
		} else {
