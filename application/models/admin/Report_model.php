...
class Report_model extends MY_Model
{
	...
	public function getDataReport($month = '', $year = '')
	{
		$query = $this->db->query("SELECT kode_pembelian, created_at, jumlah_bayar from tb_pembelian where month(created_at) =  '$month' AND year(`created_at`) =  '$year' AND (status = '1' OR status = '2' OR status = '3')"); 
