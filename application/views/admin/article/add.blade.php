...
<section class="content">
  ...
  <h2 class="box-title"><i class="fa fa-plus-square-o"></i> Tambah Data</h2>
    ...
    <div class="box-body">
      ...
      <form class="form-horizontal" action="{{site_url('admin/'.$page.'/save')}}" method="post" enctype="multipart/form-data">
      {{$csrf}}
        <div class="form-group">
          <label for="judul" class="col-sm-2 control-label">Judul</label>
          <div class="col-sm-6">
            <input autofocus="autofocus" type="text" name="judul" class="form-control" value="{{set_value('judul')}}" id="judul">
          </div>
        </div>
        <div class="form-group">
          <label for="isi" class="col-sm-2 control-label">Konten</label>
          <div class="col-sm-9"> 
            <textarea id="isi" name="isi" rows="10" cols="80"> {{set_value('isi')}}
            </textarea>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input type="file" name="foto" class="form-control" value="{{set_value('foto')}}" id="foto"><br><?php $img = isset($data->foto) ? set_news_picture($data->foto) : 'default.png';?> 
