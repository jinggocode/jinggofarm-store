...
@section('content')
    ...
    <section class="content">
      ...
      <div class="box-header with-border">
        <a href="{{site_url('admin/kurir/lists/add')}}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
      </div>
        <div class="box-body">
          <div class="row">
            <div class="col-lg-6 col-md-6">
                <form class="form-inline" action="{{site_url('admin/'.$page.'/lists/search')}}" method="get">
          ...
          <table class="table table-hover table-striped">
              ...
              <?php else: ?>
                  ...
                  <tr>
                    ...
                    <td>  
                      <a href="{{site_url('admin/'.$page.'/lists/edit/'.$row->id)}}" class="btn btn-warning btn-sm"><i class="fa fa-pencil-square-o"></i> Edit</a>
                      <a href="{{site_url('admin/'.$page.'/lists/delete/'.$row->id)}}" onclick="return confirm('apakah anda yakin?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Hapus</a>
                    </td>
                  </tr>
                  @endforeach 
              <?php endif ?>
