    ...
    <div class="box-body">
      ...
      {{$csrf}}
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="text" name="harga_produksi" class="form-control" value="{{set_value('harga_produksi')}}" id="harga_produksi" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <label>
              <input type="radio" name="opsi_kirim" id="opsi_kirim" value="0" {{(set_value('opsi_kirim') == '0')?'checked':''}}>
              Pengiriman Umum (JNE, POS, dll.)
            </label><br>
            <label>
              <input type="radio" name="opsi_kirim" id="opsi_kirim" value="1" {{(set_value('opsi_kirim') == '1')?'checked':''}}>
              Pengiriman Lokal
            </label>
          </div>
        </div>
