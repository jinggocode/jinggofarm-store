...
@section('content')
    ...
    <section class="content">
      ...
      <div class="box-header with-border">
        <a href="{{site_url('admin/product/add')}}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
      </div>
        <div class="box-body">
          <div class="row">
          ...
          <table class="table table-hover table-striped">
              ...
              <?php else: ?>
                  ...
                  <tr>
                    <td>{{$start++}}.</td>
                    <td><img src="{{base_url('uploads/product/'.$row->foto)}}" class="img-fluid" width="100"></td>
                    <td>{{$row->nama}}</td>
                    <td>{{(money($row->harga_produksi))}}</td>
