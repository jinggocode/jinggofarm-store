...
<section class="content">
  ...
  <h2 class="box-title"><i class="fa fa-plus-square-o"></i> Edit Data</h2>
    ...
    <div class="box-body">
      ...
      <form class="form-horizontal" action="{{site_url('admin/user/update')}}" method="post" enctype="multipart/form-data">
      {{$csrf}}
      {{form_hidden('id', $data->id)}}
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input type="password" name="password" placeholder="Isi jika ingin di Ubah" class="form-control" value="{{set_value('password')}}" id="password">
          </div>
        </div> 
        <div class="form-group">
