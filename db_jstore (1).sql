...
--
-- Host: localhost
-- Generation Time: May 20, 2018 at 11:17 AM
...
(6, 16, 'Admin Dimas', '1800805', 'TF_PFJVPZQB_20180409122424.JPG', '1', '2018-04-09 12:24:25', 1, '2018-04-09 12:41:13', 1),
(7, 17, 'Dimas', '564654', 'TF_QHAHDPNI_20180409123201.jpg', '1', '2018-04-09 12:32:01', 25, '2018-04-09 12:48:20', 1),
(8, 19, 'Dimas', '564654', 'TF_NIYBIZAP_20180415083605.jpg', '1', '2018-04-15 08:36:05', 29, '2018-04-15 08:39:01', 1),
(9, 21, 'Dimas', '564654', 'TF_HLYVWVXX_20180519104513.png', '1', '2018-05-19 10:45:13', 1, '2018-05-19 11:03:50', 1);
...
CREATE TABLE `tb_detail_pembelian` (
  ...
  `status_testimoni` enum('0','1') NOT NULL DEFAULT '0',
  `created_at` datetime DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL
...
INSERT INTO `tb_detail_pembelian` (`id`, `id_pembelian`, `id_produk`, `qty`, `subtotal`, `status_testimoni`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(3, 9, 4, 1, 100000, '0', '2018-04-02 21:50:05', 1, NULL, NULL),
(4, 9, 5, 1, 100, '0', '2018-04-02 21:50:05', 1, NULL, NULL),
(5, 10, 4, 1, 100000, '0', '2018-04-02 22:10:53', 1, NULL, NULL),
(6, 10, 5, 1, 100, '0', '2018-04-02 22:10:53', 1, NULL, NULL),
(7, 11, 6, 1, 150000, '0', '2018-04-02 22:17:32', 1, NULL, NULL),
(8, 11, 7, 1, 20000, '0', '2018-04-02 22:17:32', 1, NULL, NULL),
(9, 12, 7, 2, 40000, '0', '2018-04-03 10:08:46', 1, NULL, NULL),
(10, 12, 6, 1, 150000, '0', '2018-04-03 10:08:46', 1, NULL, NULL),
(11, 13, 7, 2, 40000, '0', '2018-04-03 11:54:10', 1, NULL, NULL),
(12, 13, 6, 1, 150000, '0', '2018-04-03 11:54:10', 1, NULL, NULL),
(13, 14, 6, 6, 900000, '0', '2018-04-03 12:11:10', 1, NULL, NULL),
(14, 15, 6, 3, 450000, '0', '2018-04-09 04:29:42', 25, NULL, NULL),
(15, 16, 6, 1, 10000, '1', '2018-04-09 12:23:04', 1, '2018-04-15 10:53:04', 1),
(16, 17, 8, 3, 30000, '0', '2018-04-09 12:31:27', 25, NULL, NULL),
(17, 18, 8, 1, 10000, '0', '2018-04-15 15:30:44', 29, NULL, NULL),
(18, 18, 10, 1, 10000, '0', '2018-04-15 15:30:44', 29, NULL, NULL),
(19, 19, 7, 1, 10000, '1', '2018-04-15 15:33:04', 29, '2018-04-15 08:39:34', 29),
(20, 19, 9, 1, 10000, '1', '2018-04-15 15:33:04', 29, '2018-04-15 08:39:45', 29),
(21, 20, 6, 2, 20000, '0', '2018-04-16 12:16:29', 1, NULL, NULL),
(22, 21, 10, 5, 60000, '1', '2018-05-19 15:13:59', 1, '2018-05-19 11:05:01', 1);
...
INSERT INTO `tb_kurir` (`id`, `nama_kurir`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(1, 'kurir A', NULL, NULL, '2018-05-20 05:53:55', 1);
...
INSERT INTO `tb_ongkir` (`id`, `id_kurir`, `id_kecamatan`, `biaya`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(1, 1, 3510010, 20000, NULL, NULL, NULL, NULL);
...
CREATE TABLE `tb_pembelian` (
  ...
  `status` enum('0','1','2','3','4') NOT NULL DEFAULT '0' COMMENT '0 : belum bayar, 1: sudah bayar, 2:valid menunggu resi, 3:resi dikirim, 4:batal tidak valid',
  `no_resi` varchar(50) DEFAULT NULL,
  `batas_bayar` datetime DEFAULT NULL,
  `jumlah_bayar` int(11) DEFAULT NULL,
  `tipe_beli` enum('0','1') NOT NULL DEFAULT '0' COMMENT '0:produk, 1:susu',
  `created_at` datetime DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL
...
INSERT INTO `tb_pembelian` (`id`, `id_user`, `nama_penerima`, `nomor_hp`, `email`, `kode_pembelian`, `biaya_kirim`, `kabupaten_id`, `kecamatan_id`, `provinsi_id`, `detail_alamat`, `kurir`, `status`, `no_resi`, `batas_bayar`, `jumlah_bayar`, `tipe_beli`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(11, 21, NULL, NULL, NULL, 'OR-0001', 19000, 31, NULL, 11, 'asd', 'pos', '3', '081123581344', NULL, 170000, '0', '2018-04-02 22:17:32', 1, '2018-04-13 07:42:26', 1),
(12, 22, NULL, NULL, NULL, 'OR-0002', 8000, 179, NULL, 11, 'lorem', 'jne', '2', NULL, NULL, 190000, '0', '2018-04-03 10:08:46', 1, '2018-04-03 11:42:20', 1),
(13, 23, NULL, NULL, NULL, 'OR-0003', 46000, 66, NULL, 15, 'lorem', 'jne', '3', NULL, NULL, 190000, '0', '2018-04-03 11:54:10', 1, '2018-04-09 05:33:28', 1),
(14, 24, NULL, NULL, NULL, 'OR-0004', 7000, 51, NULL, 11, 'asd', 'jne', '4', NULL, NULL, 900000, '0', '2018-04-03 12:11:10', 1, '2018-04-03 12:11:51', 1),
(15, 25, 'Dimas Ferian JJ', '082146631959', NULL, 'OR-0005', 7000, 51, NULL, 11, 'lorem', 'jne', '3', '123123', NULL, 450000, '0', '2018-04-09 04:29:42', 25, '2018-04-09 05:38:04', 1),
(16, 1, 'Admin Dimas', '08113581344', 'admin@admin.com', 'OR-0006', 5000, 160, NULL, 11, 'Jember', 'jne', '3', '361555401029', NULL, 10000, '0', '2018-04-09 12:23:04', 1, '2018-04-09 12:41:29', 1),
(17, 25, 'Dimas Ferian JJ', '082146631959', 'dimas@dimas.com', 'OR-0007', 7000, 51, NULL, 11, 'lorem', 'jne', '4', NULL, NULL, 30000, '0', '2018-04-09 12:31:27', 25, '2018-04-09 12:48:20', 1),
(18, 29, 'Lionel Messi', '085252123123', 'messi@messi.com', 'OR-0008', 53000, 77, NULL, 7, 'lorem', 'pos', '4', NULL, '0000-00-00 00:00:00', 20000, '0', '2018-04-15 15:30:44', 29, '2018-04-15 08:32:27', 29),
(19, 29, 'Lionel Messi', '085252123123', 'messi@messi.com', 'OR-0009', 32500, 18, NULL, 13, 'ansgdabjksd', 'pos', '3', '1212121212', '2018-04-15 19:30:04', 20000, '0', '2018-04-15 15:33:04', 29, '2018-04-15 08:39:19', 1),
(20, 1, 'Admin', '08113581344', 'admin@admin.com', 'OR-0010', 41000, 415, NULL, 12, 'mbjdkhjkbnm', 'jne', '4', NULL, '2018-04-16 16:13:29', 20000, '0', '2018-04-16 12:16:29', 1, '2018-04-16 16:13:24', NULL),
(21, NULL, 'Rahmat', '85735030674', 'rahmatramadhan.ti.poliwangi@gm', 'OR-0011', 20000, 3510, 3510010, 35, 'asd', '', '3', '41561545', '2018-05-19 19:10:59', 60000, '1', '2018-05-19 15:13:59', 1, '2018-05-19 11:04:37', 1);
...
CREATE TABLE `tb_produk` (
  ...
  `opsi_kirim` enum('0','1') DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL
...
INSERT INTO `tb_produk` (`id`, `id_kategori`, `nama`, `slug`, `deskripsi`, `berat`, `harga_produksi`, `harga_jual`, `stok`, `sisa_stok`, `foto`, `opsi_kirim`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(6, 2, 'Sabun Susu Serai Wangi', 'sabun-susu-serai-wangi', 'Sabun Susu Serai Wangi adalah produk sabun yang terbuat dari susu sapi dan campuran serai wangi. Ada banyak manfaat yang diperoleh  Produk sabun yang memakai bahan dasar susu sudah terbukti memiliki efektifitas yang sangat baik dalam mengatasi masalah pada kulit, termasuk pada kulit wajah. Selain itu campuran serai wangi menambah aroma khas dan memiliki khasiat tersendiri.', 100, 5000, 10000, 10, 4, 'PRD_FAWKJEGP_20180515035359.png', '0', '2018-04-02 22:13:57', 1, '2018-05-15 04:33:05', 1),
(7, 2, 'Sabun Susu Cengkeh', 'sabun-susu-cengkeh-1', 'Sabun Susu Cengkeh adalah produk sabun yang terbuat dari susu sapi dan campuran rempah cengkeh. Ada banyak manfaat yang diperoleh  Produk sabun yang memakai bahan dasar susu sudah terbukti memiliki efektifitas yang sangat baik dalam mengatasi masalah pada kulit, termasuk pada kulit wajah. Selain itu campuran cengkeh bisa membantu mengatasi jerawat, menghilangkan flek hitam, mengatasi selulit, dan menjaga suhu tubuh tetap hangat.', 100, 5000, 10000, 10, 4, 'PRD_NFAKUJPW_20180515035406.png', '0', '2018-04-02 22:15:04', 1, '2018-05-15 04:33:15', 1),
(8, 2, 'Sabun Susu Zaitun', 'sabun-susu-zaitun', 'Sabun Susu Zaitun adalah produk sabun yang terbuat dari susu sapi dan campuran minyak zaitun. Ada banyak manfaat yang diperoleh  Produk sabun yang memakai bahan dasar susu sudah terbukti memiliki efektifitas yang sangat baik dalam mengatasi masalah pada kulit, termasuk pada kulit wajah. Selain itu minyak zaitun dapat membantu mengangkat sel kulit mati dan membantu terjadinya regenerasi kulit.', 100, 8000, 10000, 10, 10, 'PRD_FMLUFFOJ_20180515035416.png', '0', '2018-04-09 12:26:00', 1, '2018-05-15 04:33:20', 1),
(9, 2, 'Sabun Susu VCO', 'sabun-susu-vco-1', 'Sabun Susu Sapi Plus Virgin Coconut Oil (VCO) adalah sabun wajah yang terbuat dari ekstrak minyak kelapa murni dan susu sapi murni untuk merawat kulit wajah dan tubuh. Diolah serta diproses secara tradisional sehingga tidak mengandung bahan kimia. Manfaat Sabun Susu VCO : Mengencangkan kulit, Mencegah keriput dan penuaan dini, Menghilangkan jerawat dan komedo, Mengurangi flek-flek hitam pada wajah, Mencerahkan wajah, Membuat kulit wajah lebih kenyal dan tidak kendor, Mengurangi kadar minyak diwajah sehingga wajah terlihat bersih dan kesat.', 100, 6000, 10000, 10, 9, 'PRD_KYYHAWBT_20180515035423.png', '0', '2018-04-09 12:28:13', 1, '2018-05-15 04:33:25', 1),
(10, 1, 'Susu Segar', 'susu-segar', 'Minimal pembelian 5 Liter', 1000, 5000, 12000, 10, 5, 'PRD_MGLNXFNW_20180515035430.png', '1', '2018-04-09 12:30:33', 1, '2018-05-19 11:03:51', 1);
...
INSERT INTO `tb_testimoni` (`id`, `id_produk`, `nama_pelanggan`, `ulasan`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(5, 6, 'Dimas Ferian JJ', 'oke', '2018-04-15 08:23:27', 25, NULL, NULL),
(6, 7, 'Lionel Messi', 'lorem ipsum\r\n', '2018-04-15 08:39:34', 29, NULL, NULL),
(7, 9, 'Lionel Messi', 'siappp', '2018-04-15 08:39:45', 29, NULL, NULL),
(8, 6, 'Admin Dimas', 'Produk Sangat Baik', '2018-04-15 10:53:04', 1, NULL, NULL),
(9, 10, 'Rahmat', 'barang sudah sampai', '2018-05-19 11:05:01', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `tb_w_kabupaten`
--

CREATE TABLE `tb_w_kabupaten` (
...
--
-- Dumping data for table `tb_w_kabupaten`
--

INSERT INTO `tb_w_kabupaten` (`id`, `province_id`, `name`) VALUES
...
--
-- Table structure for table `tb_w_kecamatan`
--

CREATE TABLE `tb_w_kecamatan` (
...
--
-- Dumping data for table `tb_w_kecamatan`
--

INSERT INTO `tb_w_kecamatan` (`id`, `regency_id`, `name`) VALUES
...
--
-- Table structure for table `tb_w_provinsi`
--

CREATE TABLE `tb_w_provinsi` (
  `id` char(2) COLLATE utf8_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `tb_w_provinsi`
--

INSERT INTO `tb_w_provinsi` (`id`, `name`) VALUES
('11', 'ACEH'),
('12', 'SUMATERA UTARA'),
('13', 'SUMATERA BARAT'),
('14', 'RIAU'),
...
(1, '192.168.137.1', 1, 'admin', '$2y$10$v67c71lQ/pdo8UkeJm9skevVuubRpdVqCtDuB5gAHiAHb/iUEOxWm', '', 'admin@admin.com', NULL, NULL, NULL, NULL, 0, 1526785570, 1, 'Admin', NULL, NULL, NULL, NULL, NULL, NULL, '2018-04-08 23:59:18', 25),
...
(25, '::1', 2, NULL, '$2y$10$v67c71lQ/pdo8UkeJm9skevVuubRpdVqCtDuB5gAHiAHb/iUEOxWm', NULL, 'dimas@dimas.com', NULL, NULL, NULL, NULL, 0, 1523281459, 1, 'Dimas Ferian JJ', '082146631959', 11, 51, 'lorem', '2018-04-08 17:10:36', 1, '2018-04-09 03:45:41', 25),
(26, '36.82.99.223', 2, NULL, '$2y$10$cWMCvQN8K7exrMQIpVgsHerW0MaYyu3cxdzFP/ZJ3zNplih9uiXDq', NULL, 'rahmat@rahmat.com', NULL, NULL, NULL, NULL, 0, 1523268542, 1, 'rahmat rp', '082146631959', NULL, NULL, NULL, '2018-04-09 10:02:30', 1, NULL, NULL),
(27, '180.253.83.1', 2, NULL, '$2y$10$DA.RDSJBYeuLKiEAU4QAce.i2z5ng2LBrRITapyyRQHH4G.BfdYxq', NULL, 'user@user.com', NULL, NULL, NULL, NULL, 0, 1523282634, 1, 'Pelanggan', '082146631959', NULL, NULL, NULL, '2018-04-09 13:50:38', 1, NULL, NULL),
(28, '180.247.240.64', 2, NULL, '$2y$10$sMHkIJ.l5KsZp1RRWW6iFO7hoF4qQk4Gv3ovp5YP.CcpC8AITtlAq', NULL, 'dimas@user.com', NULL, NULL, NULL, NULL, 0, 1523284706, 1, 'dimas', '08113581344', NULL, NULL, NULL, '2018-04-09 14:37:57', 1, NULL, NULL),
(29, '180.247.240.149', 2, NULL, '$2y$10$v67c71lQ/pdo8UkeJm9skevVuubRpdVqCtDuB5gAHiAHb/iUEOxWm', NULL, 'messi@messi.com', NULL, NULL, NULL, NULL, 0, 1526349548, 1, 'Lionel Messi', '085252123123', NULL, NULL, NULL, '2018-04-15 08:19:10', 1, NULL, NULL);
...
ALTER TABLE `tb_ongkir`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_tb_ongkir_tb_kurir` (`id_kurir`);
...
ALTER TABLE `tb_testimoni`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_tb_testimoni_tb_produk` (`id_produk`);

--
-- Indexes for table `tb_w_kabupaten`
--
ALTER TABLE `tb_w_kabupaten`
  ADD PRIMARY KEY (`id`),
  ADD KEY `regencies_province_id_index` (`province_id`);

--
-- Indexes for table `tb_w_kecamatan`
--
ALTER TABLE `tb_w_kecamatan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `districts_regency_id_index` (`regency_id`);

--
-- Indexes for table `tb_w_provinsi`
--
ALTER TABLE `tb_w_provinsi`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `tb_ongkir`
  ADD CONSTRAINT `FK_tb_ongkir_tb_kurir` FOREIGN KEY (`id_kurir`) REFERENCES `tb_kurir` (`id`);
...
--
ALTER TABLE `tb_testimoni`
  ADD CONSTRAINT `FK_tb_testimoni_tb_produk` FOREIGN KEY (`id_produk`) REFERENCES `tb_produk` (`id`);

--
-- Constraints for table `tb_w_kabupaten`
--
ALTER TABLE `tb_w_kabupaten`
  ADD CONSTRAINT `regencies_province_id_foreign` FOREIGN KEY (`province_id`) REFERENCES `tb_w_provinsi` (`id`);

--
-- Constraints for table `tb_w_kecamatan`
--
ALTER TABLE `tb_w_kecamatan`
  ADD CONSTRAINT `districts_regency_id_foreign` FOREIGN KEY (`regency_id`) REFERENCES `tb_w_kabupaten` (`id`);
COMMIT;
